                ...
                <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="space-y-4 pt-2">
                         <div>
                            ...
                            <input id="name" name="name" type="text" value={formData[activeTab].name} onChange={handleLocaleChange} disabled={isReadOnly} className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-md p-2 disabled:bg-gray-200" />
                        </div>
                         <div>
                            <label htmlFor="about" className="block text-sm font-medium text-gray-700">{t('aboutCompany')}</label>
                            <textarea id="about" name="about" value={formData[activeTab].about} onChange={handleLocaleChange} disabled={isReadOnly} rows={5} className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-md p-2 resize-y disabled:bg-gray-200" />
                        </div>
                    </div>
                </div>

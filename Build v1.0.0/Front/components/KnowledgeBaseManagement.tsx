                ...
                <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl m-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input id="tag" name="tag" value={tag} onChange={(e) => setTag(e.target.value)} className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-md p-2" placeholder={t('kbTagPlaceholder')}/>
                        </div>
                        <div>
                            <label htmlFor="content" className="block text-sm font-medium text-gray-700">{t('kbContentLabel')}</label>
                            <textarea id="content" name="content" value={content} onChange={(e) => setContent(e.target.value)} rows={8} className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-md p-2 resize-y" placeholder={t('kbContentPlaceholder')}/>
                        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
          <input
            ...
            className="w-full sm:flex-grow max-w-sm bg-gray-50 border border-gray-300 rounded-md p-2 ps-4 text-sm"
          />
          {!isReadOnly && (

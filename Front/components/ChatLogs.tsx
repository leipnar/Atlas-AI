    ...
    if (selectedConversation) {
        return (
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col h-full">
                <div className="flex-shrink-0 p-4 border-b border-gray-200 flex flex-wrap gap-4 justify-between items-center">
    ...
    return (
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            <input
                ...
                className="w-full max-w-sm bg-gray-50 border border-gray-300 rounded-md p-2 ps-4 text-sm mb-4"
            />
